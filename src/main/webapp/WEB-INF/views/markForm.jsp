    ...
    <body>
        ...
        <div align="center">
            <div align="center" class="box">
                ...
                <%
                    Lesson lesson = ((Mark)request.getAttribute("command")).getLesson();
                %>
                <p>Teacher:<%=lesson.getTheme().getSubjectDetails().getTeacher().getName()%></p>
                <p>Subject:<%=lesson.getTheme().getSubjectDetails().getSubject().getName()%></p>
                ...
                <form:form>
                    ...
                    <form:select path="pupil.id">
                        ...
                        %>
                                <option value="<%=pupil.getId()%>"
                                        <%=(int)request.getAttribute("selectedPupil") == pupil.getId() ? "selected='selected'":""%>>
                                    <%=pupil.getName()  %>
                                </option>
                        <%
                            }
